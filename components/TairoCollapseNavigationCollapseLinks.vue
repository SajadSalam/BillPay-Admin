...
<template>
    <div class="group">
        <button
            ref="buttonRef"
            class="text-white dark:text-muted-400/80 hover:text-muted-200 dark:hover:text-muted-200 flex w-full items-center rounded-3xl py-3 transition-colors duration-300"
      ...
      >
        ...
        >
            <li
                ...
                :key="child.to"
                class="border-muted-300 dark:border-muted-700 ms-2"
            >
                <NuxtLink
                    :to="child.to"
                    exact-active-class="!text-white border border-muted-100"
                    class="text-muted-500 dark:text-muted-400/80 dark:hover:text-muted-200 hover:text-white relative rounded-3xl -start-0.5 flex cursor-pointer items-center gap-2 py-3 px-4 transition-colors duration-300"
                >
                    <Icon

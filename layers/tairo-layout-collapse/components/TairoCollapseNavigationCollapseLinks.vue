...
<template>
  <div class="group">
    <button
      ref="buttonRef"
      class="nui-focus text-muted-500 dark:text-muted-400/80 hover:bg-muted-500 dark:hover:bg-muted-700/60 hover:text-muted-200 dark:hover:text-muted-200 flex w-full cursor-pointer items-center rounded-3xl py-3 transition-colors duration-300"
